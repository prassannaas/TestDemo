...
<html>
	...
	<body bgcolor="#FFEBCD">
		<form action="./EditOpportunity?opportunityid=${opportunities.opportunityid}">
		
			<table cellpadding="2" width="40%"  align="center" cellspacing="2" >
				<tr>
					<td align="center" colspan="2"><font size="4">Edit Opportunity</td>
				</tr>
				<tr>
					<td><font size="4">Opportunity ID:</td>
					<td><input type="text" name="opportunityid" value="${opportunities.opportunityid}"/></td>
				</tr>
				<tr>
					<td><font size="4">Subject:</td>
					<td><input type="text" name="subject" value="${opportunities.subject}"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<SELECT name="type" value="${opportunities.type}">
				...
				<tr>
					...
					<td>
						<SELECT name="status" value="${opportunities.status}">
				...
				<tr>
					...
					<td><input type="text" name="probability" value="${opportunities.probability}"/></td>
				</tr>
				<tr>
					<td><font size="4">Notes:</td>
					<td><textarea rows="3" cols="17" name="notes" value="${opportunities.notes}"></textarea></td>
				</tr>
